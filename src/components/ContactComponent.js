                    ...
                    <div className="col-12 col-md-9">
                        <LocalForm onSubmit={(values)=>this.handleSubmit(values)}>
                            <Row className="form-group" row>
                                ...
                                <Col md={10}>
                                    <Control.text model=".firstname"  className="form-control"  id="firstname"
                                        validators={{required,minLength:minLength(3),maxLength: maxLength(10)}} name="firstname" placeholder="First Name"/>
                                    <Errors
                            ...
                            <Row className="form-group" row>
                                ...
                                <Col md={10}>
                                    <Control.text model=".lastname" validators={{required,minLength:minLength(3),maxLength: maxLength(10)}} className="form-control" id="lastname" name="lastname" placeholder="Last Name" />
                                    <Errors
                            ...
                            <Row className="form-group" row>
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum"  validators={{required,minLength:minLength(3),maxLength: maxLength(15),isNumber}} className="form-control" id="telnum" name="telnum" placeholder="Tel. Number" />
                                    <Errors
                            ...
                            <Row className="form-group" row>
                                ...
                                <Col md={10}>
                                    <Control.text model=".email" validators={{required,validEmail}} className="form-control" id="email" name="email" placeholder="Email" />
                                    <Errors
